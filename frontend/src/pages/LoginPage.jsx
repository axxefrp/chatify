            ...
            <div className="md:w-1/2 p-8 flex items-center justify-center md:border-r border-brand-primary/30">
              <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                  ...
                  <h2 className="text-3xl font-bold bg-gradient-to-r from-brand-primary to-brand-accent bg-clip-text text-transparent mb-2">Welcome Back</h2>
                  <p className="text-slate-400">Login to access your cosmic conversations</p>
                </div>
