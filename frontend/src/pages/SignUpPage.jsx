              ...
              <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                  <div className="relative mb-4">
                    ...
                    <div className="absolute inset-0 bg-brand-accent/20 blur-xl animate-glow rounded-full"></div>
                  </div>
                  <h2 className="text-3xl font-bold bg-gradient-to-r from-brand-accent to-brand-primary bg-clip-text text-transparent mb-2">Join the Cosmos</h2>
