...
export function createPasswordResetEmailTemplate(name, resetURL) {
  ...
  <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f5f5f5;">
    <div style="background: linear-gradient(to right, #8b5cf6, #06b6d4); padding: 30px; text-align: center; border-radius: 12px 12px 0 0;">
    ...
    <div style="background-color: #ffffff; padding: 35px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
      <p style="font-size: 18px; color: #8b5cf6;"><strong>Hello ${name},</strong></p>
      <p>You recently requested to reset your password for your Chatify account. Click the button below to reset it.</p>

      <div style="background-color: #fef2f2; padding: 20px; border-radius: 10px; margin: 25px 0; border-left: 4px solid #ef4444;">
        <p style="font-size: 14px; margin: 0; color: #dc2626;"><strong>Security Notice:</strong> This link will expire in 10 minutes for your security.</p>
      </div>

      <div style="text-align: center; margin: 30px 0;">
        <a href=${resetURL} style="background: linear-gradient(to right, #8b5cf6, #06b6d4); color: white; text-decoration: none; padding: 15px 40px; border-radius: 50px; font-weight: 600; display: inline-block; font-size: 16px;">Reset Password</a>
      </div>
    ...
    <div style="text-align: center; padding: 20px; color: #999; font-size: 12px;">
      ...
      <p>
        <a href="#" style="color: #8b5cf6; text-decoration: none; margin: 0 10px;">Privacy Policy</a>
        <a href="#" style="color: #8b5cf6; text-decoration: none; margin: 0 10px;">Terms of Service</a>
        <a href="#" style="color: #8b5cf6; text-decoration: none; margin: 0 10px;">Contact Us</a>
      </p>
    </div>
  </body>
  </html>
